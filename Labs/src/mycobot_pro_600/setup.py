...
setup(
    ...
    entry_points={
        'console_scripts': [
            'slider_control = mycobot_pro_600.slider_control:main',
            'FK = mycobot_pro_600.FK:main',
            # 'IK = mycobot_pro_600.IK:main',
            'img_process_publisher = mycobot_pro_600.img_processor_publisher:main',
            'cobot_subscriber = mycobot_pro_600.cobot_subscriber:main',
            'set_home = mycobot_pro_600.set_home:main',
            'maze_solver_publisher = mycobot_pro_600.maze_solver_publisher:main',
        ],
    },
)
